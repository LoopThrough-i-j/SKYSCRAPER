...
public class DisplayManager {
    private JFrame StoreManagementUI, customerRegistrationUI, homeUI, loginUI, manageStore, registerStore, searchForMedicine, register;
    ...
    public void showStoreManagementUI(boolean show){
        if(StoreManagementUI == null) StoreManagementUI = new StoreManagementUI(sysMgr, this);
        StoreManagementUI.setVisible(show);
    }
